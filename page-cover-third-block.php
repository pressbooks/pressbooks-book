<section class="cover-information">
	...
	<div class="cover-information__description">
		...
		<div class="cover-information__lead-author">
		...
		<div class="cover-information__contributing-authors">
			<h3><?php _e( 'Contributing Authors', 'pressbooks-book' ); ?></h3>
				<?php echo $book_information['pb_contributing_authors']; ?>
		</div>
		<?php } ?>
		<div class="cover-information__license">
			<h3><?php _e( 'License', 'pressbooks-book' ); ?></h3>
			<?php echo pressbooks_copyright_license(); // TODO ?>
		</div>
		<?php if ( ! empty( $book_information['pb_keywords_tags'] ) ) { ?>
		<div class="cover-information__subject">
