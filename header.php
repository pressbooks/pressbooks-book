...
<svg style="position: absolute; width: 0; height: 0;" width="0" height="0" xmlns="http://www.w3.org/2000/svg">
	<defs>
		...
		<symbol id="arrow-left" fill="currentColor" viewBox="0 10 512 420"><path d="M220 45c0 6-3 12-7 17L79 200h410c12 0 23 11 23 25 0 13-11 24-23 24H79l134 138c4 5 7 11 7 17 0 7-3 13-7 18-10 9-24 9-33 0L7 242c-9-10-9-25 0-34L180 26c9-9 23-9 33 0 4 5 7 11 7 19"/></symbol>
		<symbol id="arrow-right" fill="currentColor" viewBox="0 0 512 410"><path d="M291 32c0 6 3 12 7 17l133 135H23c-13 0-23 11-23 24s10 24 23 24h408L298 367c-4 4-7 10-7 16s3 12 7 17c10 9 24 9 33 0l173-176c9-9 9-23 0-33L331 15c-9-10-23-10-33 0-4 4-7 10-7 17"/></symbol>
		<symbol id="arrow-up" fill="currentColor" viewBox="20 0 430 492"><path d="M424 189c-6 0-11-2-16-6L278 55v392c0 12-10 22-23 22-12 0-22-10-22-22V55L103 183c-5 4-11 6-16 6-6 0-12-2-16-6-9-9-9-23 0-32L239-15c10-9 23-9 32 0l170 166c9 9 9 23 0 32-4 4-10 6-17 6"/></symbol>
		...
		<div class="header__container">
			<div class="header__inside">
				...
				<div class="header__nav">
					<button class="header__nav-icon js-header-nav-toggle" aria-expanded="false" aria-controls="navigation"><?php _e( 'Menu', 'pressbooks-book' ); ?><span class="header__nav-icon__icon"></span></button>
		...
		<?php if ( \PressbooksBook\Helpers\should_cta_banner_be_displayed() && \PressbooksBook\Helpers\is_book_public() ) : ?>
			<div class="cta hidden">
				<p><?php echo sprintf( esc_html__( 'Want to create or adapt books like this? %s about how Pressbooks supports open publishing practices.', 'pressbooks-book' ), sprintf( '<a href="%1$s" target="_blank">%2$s</a>', esc_url( 'https://pressbooks.com/adapt-open-textbooks?utm_source=book&utm_medium=banner&utm_campaign=bbc' ), esc_html__( 'Learn more', 'pressbooks-book' ) ) ); ?>
					<a id="close-cta" href="javascript:void()" aria-label="<?php esc_attr_e( 'Close banner', 'pressbooks-book' ); ?>">
