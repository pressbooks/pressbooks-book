<!-- Share buttons -->
	<div class="share-wrap-single">
		<ul class="share share-single">
			<?php $_mailto = 'mailto:?subject=' . rawurlencode( __( 'I wanted to share this post with you from', 'pressbooks-book' ) . ' ' . get_bloginfo( 'name' ) ) . '&amp;body=' . rawurlencode( get_the_title() . ' - ' . get_permalink() ); ?>
			<li class="email"><a href="<?php echo $_mailto; ?>" title="<?php _e( 'Email to a friend', 'pressbooks-book' ); ?>" target="_blank"><?php _e( 'Share via Email', 'pressbooks-book' ); ?></a>
			</li>
