<div class="contributor__name__and__links">
	<?php if ( $contributor['contributor_picture'] ) : ?>
		<img class="contributor__profile__picture" alt="" role="presentation" src="<?php echo $contributor['contributor_picture'] ?>"/>
		<?php endif; ?>
	...
	<?php endif; ?>
	<?php if ( $contributor['contributor_twitter'] || $contributor['contributor_linkedin'] || $contributor['contributor_github'] ) : ?>
