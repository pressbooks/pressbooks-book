	...
	<div id="sidebar">
		...
		<!-- If Logged in show ADMIN -->
			...
			<?php if ( current_user_can_for_blog( $blog_id, 'edit_posts' ) || is_super_admin() ) : ?>
				<li class="admin-btn"><a href="<?php echo get_option( 'home' ); ?>/wp-admin"><?php _e( 'Admin', 'pressbooks-book' ); ?></a></li>
			<?php endif; ?>

				<li class="home-btn"><a href="<?php echo get_option( 'home' ); ?>"><?php _e( 'Home', 'pressbooks-book' ); ?></a></li>

		<!-- TOC button always there -->
				<li class="toc-btn"><a href="<?php echo get_option( 'home' ); ?>/table-of-contents"><?php _e( 'Table of Contents', 'pressbooks-book' ); ?></a></li>
			</ul>
		...
		<div id="toc">
			<a href="#" class="close"><?php _e( 'Close', 'pressbooks-book' ); ?></a>
			<ul>
