	...
	<div class="container">
		...
		<section class="pressbooks-footer">
		  ...
		  <div class="pressbooks-footer__social">
				<a href="https://facebook.com/pressbooks2" title="<?php _e( 'Pressbooks on Facebook', 'pressbooks-book' ); ?>">
				...
				<a href="https://twitter.com/intent/follow?screen_name=pressbooks" title="<?php _e( 'Pressbooks on Twitter', 'pressbooks-book' ); ?>">
